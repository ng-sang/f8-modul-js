export function renderSidebar(currentPath) {
  // Hàm helper để tạo item sidebar
  ...
  const exploreIcon = '<path d="M12 2a10 10 0 100 20 10 10 0 000-20zm0 18a8 8 0 110-16 8 8 0 010 16zm-1-13l4 6-6 4 2-6z"></path>'; // Simplified compass
  const libraryIcon = '<path d="M4 6h16M4 12h16m-7 6h7"></path>'; // Simplified list

  return `
    <aside class="w-[100px] h-full bg-yt-black flex flex-col items-center py-2">
      ...
      <div class="flex flex-col items-center justify-center py-2 cursor-pointer text-[#909090] hover:text-white">
